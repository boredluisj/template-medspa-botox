  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex flex-col justify-center translate-y-0.5">
        <span className="font-heading text-2xl tracking-[0.15em] text-dark uppercase leading-none">
          AURA
        </span>
        <span className="text-[9px] font-sans font-medium tracking-[0.3em] text-primary-600 uppercase leading-none mt-1.5 opacity-80">
          Aesthetics
        </span>
      </div>
    </div>
